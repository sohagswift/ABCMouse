...
struct WordData{
    ...
    static let flowers = ["anemone","aster","bird of paradise","carnation","cherry blossom","chrysanthemums","daffodil","dahlia","daisy","gerbera","hyacinth","iris","jasmine","lilac","lily","lotus","magnolia","orchid","pansy","rose","sunflower","tulip","water_lily"]
